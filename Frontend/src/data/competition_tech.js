...
export const tech_competitions = [
  {
    name: 'Code Clash',
    description: 'A fast-paced brain battle where coding wizards race to solve tricky puzzles. With the\n' +
  ...
  },
  {
    ...
    description: 'This competition challenges participants to create and operate drones for specific tasks.\n' +
